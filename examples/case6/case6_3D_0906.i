[Mesh]
  ...
  [Caprock]
    ...
    block_id = 1
    bottom_left = '0 0 200'
    top_right = '2000.002 1 300'
  []
  [top]
    type = ParsedGenerateSideset
    combinatorial_geometry = 'z=1500.001'
  ...
  [right]
    type = ParsedGenerateSideset
    combinatorial_geometry = 'x=2000.002'
    new_sideset_name = 'right'
    input = 'left'
  []
  [injection_area]
    type = ParsedGenerateSideset
    combinatorial_geometry = 'x=1000.001&z=0'
